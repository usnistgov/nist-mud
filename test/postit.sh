curl -v -X PUT -u admin:admin --header "Content-Type:application/json"  --data @topology.json  http://$CONTROLLER_ADDR:8181/restconf/config/nist-cpe-nodes:cpe-collections
