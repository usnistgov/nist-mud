...
sudo -E $JAVA_HOME/bin/keytool -delete -alias toaster.nist.local -keystore $JAVA_HOME/jre/lib/security/cacerts -storepass changeit
sudo -E $JAVA_HOME/bin/keytool -importcert -file mudsigner.crt -alias toaster.nist.local -keystore $JAVA_HOME/jre/lib/security/cacerts -storepass changeit
