 ...
 */
package gov.nist.antd.baseapp.cli.commands;
...
public class BaseappCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(BaseappCliTestCommand.class);
    protected final BaseappCliCommands service;

    public BaseappCliTestCommand(final BaseappCliCommands service) {
