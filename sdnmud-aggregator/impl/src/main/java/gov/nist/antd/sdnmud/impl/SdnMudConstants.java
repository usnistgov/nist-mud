...
interface SdnMudConstants {
    ...
    FlowCookie DROP_FLOW_COOKIE = InstanceIdentifierUtils
            .createFlowCookie("DROP");

    FlowCookie UNCLASSIFIED_FLOW_COOKIE = InstanceIdentifierUtils
    ...
    FlowCookie FROM_DEVICE_FLOW_COOKIE = InstanceIdentifierUtils
