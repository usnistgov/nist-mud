...
interface SdnMudConstants {
	...
	static final Integer DST_BASE_PRIORITY = BASE_PRIORITY;
	static final Integer DST_MATCHED_GOTO_ON_QUARANTENE_PRIORITY = DST_BASE_PRIORITY + 20;
	static final Integer DST_MATCHED_DROP_ON_QUARANTINE_PRIORITY = DST_BASE_PRIORITY + 15;
	static final Integer DST_MATCHED_GOTO_FLOW_PRIORITY = DST_BASE_PRIORITY + 10;
	static final Integer DST_MATCHED_DROP_PACKET_FLOW_PRIORITY = DST_BASE_PRIORITY + 5;
