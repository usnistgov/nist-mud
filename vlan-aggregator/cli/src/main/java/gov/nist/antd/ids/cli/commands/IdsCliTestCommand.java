 ...
 */
package gov.nist.antd.vlan.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import gov.nist.antd.vlan.cli.api.IdsCliCommands;
...
public class IdsCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(IdsCliTestCommand.class);
    protected final IdsCliCommands service;

    public IdsCliTestCommand(final IdsCliCommands service) {
