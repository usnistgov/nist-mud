/*
 * Create Flows to be installed in the switch.
 * 
...
public class FlowUtils {
  ...
  private static AtomicLong actionKey = new AtomicLong(0x0);
  ...
  private static boolean isPrivateIPAddress(String ipAddress) {
    ...
    try {
      ...
      LOG.error("Exception resolving address ", e);
      return false;
    }
  ...
  private static MatchBuilder createEthernetSourceMatch(MatchBuilder matchBuilder,
  ...
  private static MatchBuilder createEthernetSourceNoEthTypeMatch(MatchBuilder matchBuilder,
      MacAddress macAddress) {
    // Set up the match field.
  ...
  private static MatchBuilder createEthernetDestMatch(MatchBuilder matchBuilder,
      MacAddress macAddress) {
  ...
  private static MatchBuilder createEthernetDestNoEthTypeMatch(MatchBuilder matchBuilder,
      MacAddress macAddress) {
  ...
  private static MatchBuilder createMetadataNoVlanMatch(MatchBuilder matchBuilder,
      BigInteger metadata) {
  ...
  private static MatchBuilder createEthernetTypeMatch(MatchBuilder matchBuilder, int ethernetType) {
    EthernetMatchBuilder ethernetMatchBuilder = new EthernetMatchBuilder().setEthernetType(
        new EthernetTypeBuilder().setType(new EtherType(Long.valueOf(ethernetType))).build());
   ...
   * 
   * @param matchBuilder -- the match builder to use.
   * 
   ...
   * 
   * @param matchBuilder -- the input match builder
   ...
   * 
   * @param targetTable -- the IDS table
  ...
  private static InstructionsBuilder createGoToNextTableInstruction(short thistable) {
    ...
    List<Instruction> instructions = new ArrayList<Instruction>();
    instructions.add(createGoToTableInstruction((short) (thistable)));
    InstructionsBuilder isb = new InstructionsBuilder();
    isb.setInstruction(instructions);
    return isb;
  }
  ...
  private static Instruction createPopVlanActionInstruction(int actionKey, int instructionKey) {
    Action popVlanAction = new ActionBuilder()
        .setAction(new PopVlanActionCaseBuilder()
            .setPopVlanAction(new PopVlanActionBuilder().build()).build())
    ...
    ApplyActionsCase applyActionsCase =
  ...
  private static Instruction createPopMplsActionInstruction(int actionKey, int instructionKey) {
    ...
    Action popMplsAction = new ActionBuilder().setOrder(0).setKey(new ActionKey(instructionKey))
        .setAction(new PopMplsActionCaseBuilder()
            .setPopMplsAction(new PopMplsActionBuilder().setEthernetType(mplsEtherType).build())
            .build())
        .build();
    List<Action> listAction = new ArrayList<>();
  ...
  private static Instruction createPopMplsAndOutputToPortInstruction(int actionKey,
      int instructionKey, String nodeId, List<Integer> outputPorts) {
  ...
  private static FlowBuilder createpermitPacketsFromNtpServerFlow(MacAddress macAddress,
      Ipv4Address ntpAddress, FlowCookie flowCookie, FlowId flowId) {
    short tableId = SdnMudConstants.SDNMUD_RULES_TABLE;
    FlowBuilder flowBuilder =
        new FlowBuilder().setTableId(tableId).setFlowName("permitPacketsFromNtp").setId(flowId)
    ...
    InstructionsBuilder isb =
        createGoToNextTableInstruction(SdnMudConstants.PASS_THRU_TABLE, flowCookie.getValue());
  ...
  private static FlowBuilder createPermitPacketsToNtpServerFlow(MacAddress macAddress,
      Ipv4Address ntpAddress, FlowCookie flowCookie, FlowId flowId) {
    short tableId = SdnMudConstants.SDNMUD_RULES_TABLE;
    FlowBuilder flowBuilder =
        new FlowBuilder().setTableId(tableId).setFlowName("permitPacketsToNtp").setId(flowId)
            .setKey(new FlowKey(flowId)).setCookie(flowCookie);
    MatchBuilder matchBuilder = new MatchBuilder();
  ...
  private static MatchBuilder createDstTcpPortMatch(MatchBuilder matchBuilder, int tcpport) {
    ...
    ipmatch.setIpProtocol((short) SdnMudConstants.TCP_PROTOCOL);
  ...
  private static MatchBuilder createDstUdpPortMatch(MatchBuilder matchBuilder, int udpPort) {
    IpMatchBuilder ipmatch = new IpMatchBuilder();
    ipmatch.setIpProtocol((short) SdnMudConstants.UDP_PROTOCOL);
    ipmatch.setIpProto(IpVersion.Ipv4);
    matchBuilder.setIpMatch(ipmatch.build());
  ...
  private static MatchBuilder createUdpPortMatch(MatchBuilder matchBuilder, int udpSrcPort,
      int udpDstPort) {
    IpMatchBuilder ipmatch = new IpMatchBuilder();
    ipmatch.setIpProtocol((short) SdnMudConstants.UDP_PROTOCOL);
    ipmatch.setIpProto(IpVersion.Ipv4);
  ...
  private static Instruction createVlanTagPacketAndSendToOutputPortInstructions(int vlanId,
  ...
  private static Instruction createSetMplsAndOutputToPortInstructions(long mplsTag,
      String outputPortUri) {
    List<Action> actionList = new ArrayList<Action>();
    ActionBuilder ab = new ActionBuilder();
  ...
  /**
   * Create Set Vlan ID Instruction - This includes push vlan action, and set field -&gt; vlan vid
   * action
   *
  ...
  private static Instruction createSetVlanAndOutputToPortInstructions(int vlanId,
    ...
    Action pushVlanAction =
        actionBuilder.setOrder(0)
            .setAction(new PushVlanActionCaseBuilder().setPushVlanAction(
    ...
    // set vlan id
    Action setVlanIdAction =
        actionBuilder.setOrder(1)
            .setAction(
                new SetFieldCaseBuilder().setSetField(new SetFieldBuilder()
  ...
  public static FlowBuilder createUnconditionalDropPacketFlow(short table, FlowId flowId,
    ...
    flowBuilder.setMatch(matchBuilder.build()).setInstructions(isb.build()).setTableId(table)
        .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie)
        .setPriority(SdnMudConstants.UNCONDITIONAL_DROP_PRIORITY).setBufferId(OFConstants.ANY)
        .setHardTimeout(0).setIdleTimeout(0)
        .setFlags(new FlowModFlags(false, false, false, false, false));
    return flowBuilder;
  ...
  public static FlowBuilder createMetadataMatchVlanTagSendToPort(FlowCookie flowCookie,
      FlowId flowId, Short tableId, String outputPortUri, int vlanTag, int time) {
    LOG.info("FlowUtils: createMetadataMatchSendToPortAndGoToL2Switch "
        + flowCookie.getValue().toString(16) + " outputPortUri " + outputPortUri + " time " + time
        + " tableId " + tableId);
    ...
    Instruction createVlanTag =
        FlowUtils.createSetVlanAndOutputToPortInstructions(vlanTag, outputPortUri);
    ...
    /*
     * Instruction gotoInstruction = ib.setOrder(3) .setInstruction(new GoToTableCaseBuilder()
     * .setGoToTable(new GoToTableBuilder().setTableId(SdnMudConstants.STRIP_VLAN_RULE_TABLE).
     * build()) .build()) .setKey(new InstructionKey(0)).build(); instructions.add(gotoInstruction);
     */
    ...
    fb.setMatch(matchBuilder.build()).setTableId(tableId)
        ...
        .setHardTimeout(time).setIdleTimeout(0)
        .setFlags(new FlowModFlags(false, false, false, false, false));
  ...
  public static FlowBuilder createMetadataMatchSetMplsTagSendToPortAndGoToTable(
      FlowCookie flowCookie, FlowId flowId, Short tableId, short targetTableId, int label,
    ...
    InstructionBuilder ib = new InstructionBuilder();
    Instruction createMplsTag =
        FlowUtils.createSetMplsAndOutputToPortInstructions(label, outputPortUri);
  ...
  public static FlowBuilder createMetadataMatchMplsTagGoToTableFlow(FlowCookie flowCookie,
      FlowId flowId, Short tableId, Short targetTable, int mplsTag, int duration) {
    LOG.info("FlowUtils: createMetadataMatchMplsTagGoToTable " + flowCookie.getValue().toString(16)
        + " tableId " + tableId + " targetTable " + targetTable + " mplsTag "
        + Integer.toHexString(mplsTag));
    ...
    Instruction goToTableInstruction =
        new InstructionBuilder().setInstruction(new GoToTableCaseBuilder()
            .setGoToTable(new GoToTableBuilder().setTableId(SdnMudConstants.L2SWITCH_TABLE).build())
            .build()).setKey(new InstructionKey(2)).setOrder(2).build();
    ...
    fb.setMatch(matchBuilder.build()).setTableId(tableId)
        .setFlowName("metadataMatchMplsTagGoToTable").setId(flowId).setKey(new FlowKey(flowId))
  ...
  public static FlowBuilder createMetadataMatchGoToTableFlow(FlowCookie flowCookie,
      BigInteger metadata, BigInteger metadataMask, FlowId flowId, Short tableId, Short targetTable,
      int duration) {
    LOG.info("FlowUtils: createMetadataMatchGoToTable " + flowCookie.getValue().toString(16)
        + " metadata " + metadata.toString(16) + " metadataMask " + metadataMask.toString(16)
        + " tableId " + tableId + " targetTable " + targetTable);


    MatchBuilder matchBuilder = new MatchBuilder();
    createMetadataMatch(matchBuilder, metadata, metadataMask);
    InstructionsBuilder insb =
        FlowUtils.createGoToNextTableInstruction(targetTable, flowCookie.getValue());

    FlowBuilder fb = new FlowBuilder();
    fb.setStrict(false);
    fb.setBarrier(true);

    fb.setMatch(matchBuilder.build()).setTableId(tableId).setFlowName("metadataMatchGoToTable")
        .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie)
  ...
  public static FlowBuilder createVlanMatchPopVlanTagAndGoToL2SwitchFlow(FlowCookie flowCookie,
      FlowId flowId, short tableId, int label) {

    MatchBuilder matchBuilder = new MatchBuilder();
    createVlanMatch(matchBuilder, label);

    FlowBuilder stripTagFlow =
        new FlowBuilder().setTableId((short) tableId).setFlowName("vlanMatchPopVlanTagGoToL2Switch")
            .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie);
    Instruction popVlanTagInstruction = createPopVlanActionInstruction(0, 0);
    Instruction goToTableInstruction =
        new InstructionBuilder().setInstruction(new GoToTableCaseBuilder()
            .setGoToTable(new GoToTableBuilder().setTableId(SdnMudConstants.L2SWITCH_TABLE).build())
            .build()).setKey(new InstructionKey(getInstructionKey())).setOrder(1).build();
  ...
  public static FlowBuilder createMplsMatchPopMplsLabelAndGoToTable(FlowCookie flowCookie,
      FlowId flowId, short tableId, short gototableId, int label) {
    MatchBuilder matchBuilder = new MatchBuilder();
    ...
    stripLabelFlow.setMatch(matchBuilder.build()).setTableId((short) tableId)
        .setFlowName("mplsMatchPopMplsTagGoToL2Switch").setId(flowId).setKey(new FlowKey(flowId))
        .setCookie(flowCookie).setPriority(SdnMudConstants.MATCHED_DROP_PACKET_FLOW_PRIORITY)
        .setInstructions(insb.build()).setBufferId(OFConstants.ANY).setHardTimeout(0)
        .setIdleTimeout(0).setFlags(new FlowModFlags(false, false, false, false, false));

    return stripLabelFlow;
  }

  public static FlowBuilder createOutputToPortsFlow(FlowCookie flowCookie, FlowId flowId,
      short tableId, String[] ports) {
    MatchBuilder matchBuilder = new MatchBuilder();
    ...
    flowBuilder.setMatch(matchBuilder.build()).setTableId((short) tableId)
        .setFlowName("outputToPortsFlow").setId(flowId).setKey(new FlowKey(flowId))
        .setCookie(flowCookie).setPriority(SdnMudConstants.MATCHED_DROP_PACKET_FLOW_PRIORITY)
        .setInstructions(insb.build()).setBufferId(OFConstants.ANY).setHardTimeout(0)
        .setIdleTimeout(0).setFlags(new FlowModFlags(false, false, false, false, false));
  ...
  public static FlowBuilder createOnMplsTagMatchPopMplsTagsAndSendToPort(FlowCookie flowCookie,
      FlowId flowId, int label, String nodeId, List<Integer> outputPorts, short tableId,
      int duration) {
    ...
    Instruction instruction =
        FlowUtils.createPopMplsAndOutputToPortInstruction(0, 0, nodeId, outputPorts);
    List<Instruction> instructions = new ArrayList<Instruction>();
    ...
    fb.setMatch(matchBuilder.build()).setTableId((short) tableId)
        .setFlowName("mplsMatchPopMplsOutputToPort").setId(flowId).setKey(new FlowKey(flowId))
        .setCookie(flowCookie).setPriority(SdnMudConstants.MATCHED_DROP_PACKET_FLOW_PRIORITY)
        .setInstructions(insb.build()).setInstallHw(false).setBufferId(OFConstants.ANY)
        .setHardTimeout(duration).setIdleTimeout(0)
        .setFlags(new FlowModFlags(false, false, false, false, false));
  ...
  public static FlowBuilder createOnMplsTagMatchPopMpsTagsSendToPortAndGoToTable(
      FlowCookie flowCookie, FlowId flowId, int label, String nodeId, List<Integer> portSpecs,
      Short tableId, Short gototableId, int duration) {
    LOG.info(
        "createOnMplsTagMatchPopMplsTagsOutputToPortsAndGoToTable " + Integer.toHexString(label));

    MatchBuilder matchBuilder = new MatchBuilder();
    FlowUtils.createMplsMatch(matchBuilder, label);
    Instruction instruction =
        FlowUtils.createPopMplsAndOutputToPortInstruction(0, 0, nodeId, portSpecs);
    List<Instruction> instructions = new ArrayList<Instruction>();
    instructions.add(instruction);
    ...
    fb.setStrict(false);
    fb.setMatch(matchBuilder.build()).setTableId((short) tableId)
        .setFlowName("onMplsTagMatchPopMpsTagsSendToPortAndGoToTable").setId(flowId)
        .setKey(new FlowKey(flowId)).setCookie(flowCookie)
        .setPriority(SdnMudConstants.MATCHED_DROP_PACKET_FLOW_PRIORITY)
        .setInstructions(insb.build()).setInstallHw(false).setBufferId(OFConstants.ANY)
        .setHardTimeout(duration).setIdleTimeout(0)
        .setFlags(new FlowModFlags(false, false, false, false, false));
   ...
   * @param flowId -- the flow Id to use
   * @param macAddress -- source mac address for match.
   * @param tableId -- the table id where the flow is to be installed.
   * @param outputPortUri -- the output port URI
   * @param time -- time in seconds.
   * @return -- the created flow.
   */

  public static FlowBuilder createOnSourceMacAddressMatchSendToPortAndGoToL2Switch(
      FlowCookie flowCookie, FlowId flowId, MacAddress macAddress, Short tableId,
      String outputPortUri, int time) {
    FlowBuilder tagPacketFlow = new FlowBuilder().setTableId(tableId)
        .setFlowName("SourceMacAddressMatchSendToPortAndGoToL2Switch").setId(flowId)
        .setKey(new FlowKey(flowId)).setCookie(flowCookie);
    MatchBuilder matchBuilder = new MatchBuilder();
    createEthernetSourceMatch(matchBuilder, macAddress);
    Instruction sendToPort = createSendToPortInstruction(outputPortUri);
    Instruction gotoInstruction =
        FlowUtils.createGoToTableInstruction(SdnMudConstants.L2SWITCH_TABLE);
    InstructionsBuilder insb = new InstructionsBuilder();
    ArrayList<Instruction> instructions = new ArrayList<Instruction>();
   ...
   * @param tableId -- the table id where the flow is installed.
   * @param outputPortUri -- the output port URI
   * @param time -- duration of the flow.
   * @param flowCookie -- the flow cookie for the flow.
  ...
  public static FlowBuilder createSrcAndDestMacAddressMatchSendToPort(FlowCookie flowCookie,
      MacAddress sourceMacAddress, MacAddress destinationMacAddress, Short tableId,
      String outputPortUri, int time) {
    FlowId flowId = InstanceIdentifierUtils.createFlowId();
    MatchBuilder matchBuilder = new MatchBuilder();
    FlowUtils.createEthernetSourceAndDestinationMatch(matchBuilder, sourceMacAddress,
    ...
    insb.setInstruction(instructions);
    FlowBuilder flowBuilder =
        new FlowBuilder().setTableId(tableId).setFlowName("OnDestinationMacAddressMatchSendToPort")
            .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie);
  ...
  public static FlowBuilder createFwdAllToControllerFlow(final Short tableId) {
    ...
    FlowBuilder allToCtrlFlow =
        new FlowBuilder().setTableId(tableId).setFlowName("allPacketsToCtrl").setId(flowId)
            .setKey(new FlowKey(flowId)).setCookie(flowCookie);
  ...
  public static FlowBuilder createDestIpMatchGoToIdsTableFlow(FlowCookie flowCookie, FlowId flowId,
    ...
    LOG.info("createPermitPacketFlow " + " FlowCookie : " + flowCookie.getValue().toString(16)
        + " macAddress " + macAddress.getValue() + " destination " + destination.getValue()
        + " protocol " + protocol);
  ...
  public static FlowBuilder createUnconditionalGoToNextTableFlow(short table, short nextTable,
      FlowId flowId, FlowCookie flowCookie) {
    LOG.info("createGoToTableFlow ");

    FlowBuilder flowBuilder = new FlowBuilder().setTableId(table).setFlowName("permitPackets")
        .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie);
  ...
  public static FlowBuilder createDropPacketOnSourceMacMatchAndSendToControllerFlow(
      FlowCookie flowCookie, FlowId flowId, MacAddress macAddress, short tableId, int idleTimeout) {

    LOG.info("createDropPacketFlow: flowCookie = " + flowCookie.getValue().toString(16)
        + " MacAddress " + macAddress.getValue());

    FlowBuilder dropPacketFlow = new FlowBuilder().setTableId(tableId).setFlowName("dropAllPackets")
        .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie);
  ...
  public static FlowBuilder createIpMatchSendPacketToControllerFlow(Short tableId,
	       FlowId flowId, FlowCookie flowCookie) {
	    MatchBuilder matchBuilder = new MatchBuilder();
	    ...
	    instructions.add(instruction);
	    insb.setInstruction(instructions);
	    FlowBuilder sendToControllerFlow =
	        new FlowBuilder().setTableId(tableId).setFlowName("uncoditionalSendToController")
	            .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie);
  ...
  public static FlowBuilder createUnconditionalSendPacketToControllerFlow(Short tableId,
      Short nextTableId, FlowId flowId, FlowCookie flowCookie) {
    MatchBuilder matchBuilder = new MatchBuilder();
    Instruction instruction = FlowUtils.createSendPacketToControllerInstruction();
  ...
  public static FlowBuilder createPermitPacketFromIpAddressOnDestMacMatch(FlowCookie flowCookie,
      FlowId flowId, MacAddress macAddress, Ipv4Address source, int port, short protocol) {
    ...
    FlowBuilder flowBuilder = new FlowBuilder().setTableId(SdnMudConstants.SDNMUD_RULES_TABLE)
        .setFlowName("permitPacketsFromIpAddressOnDestMacMatch").setId(flowId)
        .setKey(new FlowKey(flowId)).setCookie(flowCookie);
  ...
  public static FlowBuilder createPermitPacketsToDhcpServerFlow(MacAddress macAddress,
      FlowCookie flowCookie, FlowId flowId) {
    LOG.info("creatrePermitPacketsToDhcpServerFlow");

    short tableId = SdnMudConstants.SDNMUD_RULES_TABLE;
    FlowBuilder flowBuilder = new FlowBuilder().setTableId(SdnMudConstants.SDNMUD_RULES_TABLE)
        .setFlowName("permitPacketsToDhcp").setId(flowId).setKey(new FlowKey(flowId))
        .setCookie(flowCookie);
    MatchBuilder matchBuilder = new MatchBuilder();
    FlowUtils.createEthernetSourceMatch(matchBuilder, macAddress);
    FlowUtils.createUdpPortMatch(matchBuilder, SdnMudConstants.DHCP_CLIENT_PORT,
  ...
  public static FlowBuilder createPermitPacketsToDhcpServerFlow(short tableId,
      short destinationTableId, FlowCookie flowCookie, FlowId flowId) {

    LOG.info("createPermitPacketsToDhcpServerFlow ");

    FlowBuilder flowBuilder =
        new FlowBuilder().setTableId(tableId).setFlowName("permitPacketsToDhcpServerFlow")
            .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie);
    MatchBuilder matchBuilder = new MatchBuilder();
    // Set up the ports.
    ...
    Match match = matchBuilder.build();
    InstructionsBuilder isb =
        createGoToNextTableInstruction(destinationTableId, flowCookie.getValue());
    flowBuilder.setMatch(match).setInstructions(isb.build())
  ...
  public static FlowBuilder createPermitPacketsFromDhcpServerFlow(short tableId,
      short destinationTableId, FlowCookie flowCookie, FlowId flowId) {

    LOG.info("createPermitPacketsFromDhcpServerFlow ");

    FlowBuilder flowBuilder =
        new FlowBuilder().setTableId(tableId).setFlowName("permitPacketsFromDhcpServerFlow")
            .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie);
    MatchBuilder matchBuilder = new MatchBuilder();
    FlowUtils.createEthernetTypeMatch(matchBuilder, 0x800);
    FlowUtils.createUdpPortMatch(matchBuilder, SdnMudConstants.DHCP_SERVER_PORT,
  ...
  public static FlowBuilder createPermitPacketsFromDhcpServerFlow(MacAddress macAddress,
      FlowCookie flowCookie, FlowId flowId) {
    short tableId = SdnMudConstants.SDNMUD_RULES_TABLE;
    FlowBuilder flowBuilder =
        new FlowBuilder().setTableId(tableId).setFlowName("permitPacketsFromDhcpServerFlow")
  ...
  public static List<FlowBuilder> createPermitPacketsToFromNtpServerFlows(MacAddress macAddress,
    ...
    FlowBuilder toNtpFlow =
        createPermitPacketsToNtpServerFlow(macAddress, ntpAddress, flowCookie, flowId);
    retval.add(toNtpFlow);
    flowId = InstanceIdentifierUtils.createFlowId(flowIdStr);
    FlowBuilder fromNtpFlow =
        createpermitPacketsFromNtpServerFlow(macAddress, ntpAddress, flowCookie, flowId);
  ...
  public static FlowBuilder createDropPacketsOnDestMacMatchFlow(MacAddress macAddress,
    ...
    FlowBuilder flowBuilder = new FlowBuilder().setTableId(SdnMudConstants.SDNMUD_RULES_TABLE)
        .setFlowName("permitPacketsFromNtp").setId(flowId).setKey(new FlowKey(flowId))
        .setCookie(flowCookie);
    MatchBuilder matchBuilder = new MatchBuilder();
    FlowUtils.createEthernetSourceMatch(matchBuilder, macAddress);
    FlowUtils.createEthernetDestMatch(matchBuilder, destinationMacAddress);
    Match match = matchBuilder.build();
    Instruction instruction =
        FlowUtils.createGoToTableInstruction(SdnMudConstants.DROP_TABLE);
    InstructionsBuilder isb = new InstructionsBuilder();
    List<Instruction> instructions = new ArrayList<Instruction>();
    instructions.add(instruction);
    isb.setInstruction(instructions);
    ...
    flowBuilder.setMatch(match).setInstructions(isb.build())
        .setPriority(SdnMudConstants.MATCHED_DROP_PACKET_FLOW_PRIORITY_HIGH)
        .setBufferId(OFConstants.ANY).setHardTimeout(0).setIdleTimeout(0)
        .setFlags(new FlowModFlags(false, false, false, false, false));
  ...
  public static FlowBuilder createPermitPacketsFromDeviceMacToMacFlow(MacAddress deviceMacAddress,
      MacAddress destinationMacAddress, int port, short protocol, FlowCookie flowCookie,
      FlowId flowId) {
    MatchBuilder matchBuilder = new MatchBuilder();
    ...
    InstructionsBuilder isb = FlowUtils
        .createGoToNextTableInstruction(SdnMudConstants.PASS_THRU_TABLE, flowCookie.getValue());
    FlowBuilder flowBuilder = new FlowBuilder().setTableId(tableId).setFlowName("permitPacketToMac")
        .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie);
    flowBuilder.setMatch(matchBuilder.build()).setInstructions(isb.build())
        .setPriority(SdnMudConstants.MATCHED_GOTO_FLOW_PRIORITY).setBufferId(OFConstants.ANY)
        .setHardTimeout(0).setIdleTimeout(0)
  ...
  public static FlowBuilder createPermitPacketsFromMacToMacFlow(MacAddress sourceMacAddress,
      int sourcePort, MacAddress destinationMacAddress, int destinationPort, short protocol,
      FlowCookie flowCookie, FlowId flowId) {
    LOG.info("createPermitPacketsFromMacToMacFlow :" + sourceMacAddress.getValue() + " sourcePort "
        + sourcePort + " destinationMacAddress " + destinationMacAddress.getValue()
        + " destinationPort " + destinationPort + " protocol " + protocol);
    MatchBuilder matchBuilder = new MatchBuilder();
    ...
    InstructionsBuilder isb = FlowUtils
        .createGoToNextTableInstruction(SdnMudConstants.PASS_THRU_TABLE, flowCookie.getValue());
    FlowBuilder flowBuilder =
        new FlowBuilder().setTableId(tableId).setFlowName("permitPacketsFromMacToDeviceMacFlow")
            .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie);
    flowBuilder.setMatch(matchBuilder.build()).setInstructions(isb.build())
        .setPriority(SdnMudConstants.MATCHED_GOTO_FLOW_PRIORITY).setBufferId(OFConstants.ANY)
        .setHardTimeout(0).setIdleTimeout(0)
  ...
  public static FlowBuilder createVlanMatchDivertToPorts(int vlanLabel, String[] ports,
      int duration, short tableId, FlowCookie flowCookie, FlowId flowId) {
    MatchBuilder matchBuilder = new MatchBuilder();
    ...
    fb.setMatch(matchBuilder.build()).setTableId(tableId).setFlowName("vlanMatchDeliverToPorts")
        .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie)
        .setInstructions(insb.build()).setPriority(SdnMudConstants.MATCHED_GOTO_FLOW_PRIORITY)
  ...
  public static FlowBuilder createDestIpMatchSendToController(String address, int port,
      short tableId, FlowCookie flowCookie, FlowId flowId, BigInteger metadata) {
    ...
    fb.setMatch(matchBuilder.build()).setTableId(tableId).setFlowName("destIpMatchSendToController")
        .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie)
        .setInstructions(insb.build()).setPriority(SdnMudConstants.MAX_PRIORITY)
        .setBufferId(OFConstants.ANY).setHardTimeout(0).setIdleTimeout(0)
        .setFlags(new FlowModFlags(false, false, false, false, false));
    return fb;
  }

  public static FlowBuilder createMetadataMatchSendToPortsAndGotoTable(FlowCookie flowCookie,
      FlowId flowId, BigInteger metadata, BigInteger metadataMask, Short tableId,
      Short targetTableId, List<Integer> idsPorts, int duration) {
    MatchBuilder matchBuilder = new MatchBuilder();
    ...
    fb.setMatch(matchBuilder.build()).setTableId(tableId)
        .setFlowName("metadataMatchSendToPortsAndGotoTable").setId(flowId)
        .setKey(new FlowKey(flowId)).setCookie(flowCookie).setInstructions(insb.build())
        .setPriority(SdnMudConstants.MATCHED_GOTO_FLOW_PRIORITY).setBufferId(OFConstants.ANY)
        .setHardTimeout(duration).setIdleTimeout(0)
        .setFlags(new FlowModFlags(false, false, false, false, false));
  ...
  public static FlowBuilder createMetadataDestIpAndPortMatchGoTo(BigInteger metadata,
    ...
    fb.setMatch(matchBuilder.build()).setTableId(tableId)
        .setFlowName("metadataDestIpAndPortMatchGoTo").setId(flowId).setKey(new FlowKey(flowId))
        .setCookie(flowCookie).setInstructions(insb.build())
        .setPriority(SdnMudConstants.MATCHED_GOTO_FLOW_PRIORITY).setBufferId(OFConstants.ANY)
        .setHardTimeout(0).setIdleTimeout(0)
        .setFlags(new FlowModFlags(false, false, false, false, false));
  ...
  public static FlowBuilder createMetadataSrcIpAndPortMatchGoTo(BigInteger metadata,
      BigInteger metadataMask, Ipv4Address address, int destinationPort, short protocol,
      Short tableId, Short targetTable, FlowId flowId, FlowCookie flowCookie) {

    LOG.info("createMetadataSrcIpAndPortMatchGoTo metadata = " + metadata.toString(16)
        + " metadataMask = " + metadataMask.toString(16) + " ipv4Address = " + address.getValue()
        + " destinationPort = " + destinationPort + " protocol " + protocol + " tableId " + tableId
        + " targetTable = " + targetTable + " flowId " + flowId);
    MatchBuilder matchBuilder = new MatchBuilder();
    FlowUtils.createMetadataMatch(matchBuilder, metadata, metadataMask);
    FlowUtils.createEthernetTypeMatch(matchBuilder, 0x800);
    ...
    fb.setMatch(matchBuilder.build()).setTableId(tableId)
        .setFlowName("metadataSrcIpAndPortMatchGoTo").setId(flowId).setKey(new FlowKey(flowId))
        .setCookie(flowCookie).setInstructions(insb.build())
        .setPriority(SdnMudConstants.MATCHED_GOTO_FLOW_PRIORITY).setBufferId(OFConstants.ANY)
        .setHardTimeout(0).setIdleTimeout(0)
        .setFlags(new FlowModFlags(false, false, false, false, false));
  ...
  public static FlowBuilder createMetadataAndDestMacMatchGoToTableFlow(BigInteger metadata,
      BigInteger metadataMask, MacAddress destinationMacAddress, Short tableId, Short targetTable,
      FlowCookie flowCookie, FlowId flowId) {
    MatchBuilder matchBuilder = new MatchBuilder();
    createMetadataMatch(matchBuilder, metadata, metadataMask);
    ...
    fb.setMatch(matchBuilder.build()).setTableId(tableId)
        .setFlowName("metadataAndDestMacMatchGoToTable").setId(flowId).setKey(new FlowKey(flowId))
        .setCookie(flowCookie).setInstructions(insb.build())
        .setPriority(SdnMudConstants.MATCHED_GOTO_FLOW_PRIORITY).setBufferId(OFConstants.ANY)
        .setHardTimeout(0).setIdleTimeout(0)
        .setFlags(new FlowModFlags(false, false, false, false, false));
  ...
  public static FlowBuilder createMetadataMatchDropPacket(BigInteger metadata,
      BigInteger metadataMask, Short tableId, FlowCookie flowCookie, FlowId flowId) {
    MatchBuilder matchBuilder = new MatchBuilder();
    createMetadataMatch(matchBuilder, metadata, metadataMask);
    Instruction dropInstruction = FlowUtils.createDropInstruction();
    List<Instruction> instructions = new ArrayList<Instruction>();
    ...
    fb.setStrict(false);
    fb.setBarrier(true);
    fb.setMatch(matchBuilder.build()).setTableId(tableId).setFlowName("metadataMatchDropPacket")
        .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie)
        .setInstructions(insb.build())
        .setPriority(SdnMudConstants.MATCHED_DROP_PACKET_FLOW_PRIORITY_HIGH)
        .setBufferId(OFConstants.ANY).setHardTimeout(0).setIdleTimeout(0)
  ...
  public static FlowBuilder createMetadaAndProtocolMatchGoToTable(BigInteger metadata,
      BigInteger metadataMask, short protocol, short tableId, short targetTableId, FlowId flowId,
      FlowCookie flowCookie) {
    MatchBuilder matchBuilder = new MatchBuilder();
    createMetadataMatch(matchBuilder, metadata, metadataMask);
    FlowUtils.createEthernetTypeMatch(matchBuilder, 0x800);
    ...
    InstructionsBuilder insb =
        FlowUtils.createGoToNextTableInstruction(targetTableId, flowCookie.getValue());
  ...
  public static FlowBuilder createMetadaProtocolAndDestPortMatchGoToTable(BigInteger metadata,
      BigInteger metadataMask, short protocol, int port, short tableId, short targetTableId,
      FlowId flowId, FlowCookie flowCookie) {
    MatchBuilder matchBuilder = new MatchBuilder();
    createMetadataMatch(matchBuilder, metadata, metadataMask);
    FlowUtils.createEthernetTypeMatch(matchBuilder, 0x800);
    ...
    fb.setMatch(matchBuilder.build()).setTableId(tableId)
        .setFlowName("MetadaProtocolAndDestPortMatchGoToTable").setId(flowId)
        .setKey(new FlowKey(flowId)).setCookie(flowCookie).setInstructions(insb.build())
        .setPriority(SdnMudConstants.MATCHED_GOTO_FLOW_PRIORITY).setBufferId(OFConstants.ANY)
        .setHardTimeout(0).setIdleTimeout(0)
        .setFlags(new FlowModFlags(false, false, false, false, false));
  ...
  public static FlowBuilder createMetadaProtocolAndSrcPortMatchGoToTable(BigInteger metadata,
      BigInteger metadataMask, short protocol, int port, short tableId, short targetTableId,
      FlowId flowId, FlowCookie flowCookie) {
    MatchBuilder matchBuilder = new MatchBuilder();
    createMetadataMatch(matchBuilder, metadata, metadataMask);
    ...
    fb.setMatch(matchBuilder.build()).setTableId(tableId)
        .setFlowName("MetadaProtocolAndSrcPortMatchGoToTable").setId(flowId)
        .setKey(new FlowKey(flowId)).setCookie(flowCookie).setInstructions(insb.build())
        .setPriority(SdnMudConstants.MATCHED_GOTO_FLOW_PRIORITY).setBufferId(OFConstants.ANY)
        .setHardTimeout(0).setIdleTimeout(0)
        .setFlags(new FlowModFlags(false, false, false, false, false));
  ...
  public static FlowBuilder createMetadaProtocolAndSrcDestPortMatchGoToTable(BigInteger metadata,
	      BigInteger metadataMask, short protocol, int srcPort, int destPort, 
	    ...
	    createEthernetTypeMatch(matchBuilder, 0x800);
	    if (protocol == SdnMudConstants.UDP_PROTOCOL) {
	      if (srcPort != -1) createSrcUdpPortMatch(matchBuilder, srcPort);
	      if (destPort != -1) createDstUdpPortMatch(matchBuilder,destPort);
	    } else {
	      if (srcPort != -1 ) createSrcTcpPortMatch(matchBuilder, srcPort);
	      if (destPort != -1 ) createDstTcpPortMatch(matchBuilder, destPort);
	    }
  ...
  public static FlowBuilder createSourceMacMatchSetMetadataAndGoToTable(MacAddress srcMac,
      BigInteger metadata, BigInteger metadataMask, short tableId, short targetTableId,
      FlowId flowId, FlowCookie flowCookie) {
    ...
    fb.setMatch(matchBuilder.build()).setTableId(tableId)
        .setFlowName("sourceMacMatchSetMetadataAndGoToTable").setId(flowId)
        .setKey(new FlowKey(flowId)).setCookie(flowCookie).setInstructions(insb.build())
        .setPriority(SdnMudConstants.MATCHED_GOTO_FLOW_PRIORITY).setBufferId(OFConstants.ANY)
        .setHardTimeout(SdnMudConstants.CACHE_TIMEOUT / 2)
        .setIdleTimeout(SdnMudConstants.CACHE_TIMEOUT)
        .setFlags(new FlowModFlags(false, false, false, false, false));

    return fb;
  }

  public static FlowBuilder createDestMacMatchSetMetadataAndGoToTable(MacAddress dstMac,
      BigInteger metadata, BigInteger metadataMask, short tableId, short targetTableId,
      FlowId flowId, FlowCookie flowCookie) {
    ...
    fb.setMatch(matchBuilder.build()).setTableId(tableId)
        .setFlowName("destMacMatchSetMetadataAndGoToTable").setId(flowId)
        .setKey(new FlowKey(flowId)).setCookie(flowCookie).setInstructions(insb.build())
        .setPriority(SdnMudConstants.MATCHED_GOTO_FLOW_PRIORITY).setBufferId(OFConstants.ANY)
        .setHardTimeout(SdnMudConstants.CACHE_TIMEOUT / 2)
        .setIdleTimeout(SdnMudConstants.CACHE_TIMEOUT)
  ...
  public static FlowBuilder createSourceMacMatchGoToTableFlow(MacAddress macAddress, Short tableId,
      Short targetTable, FlowId flowId, FlowCookie flowCookie) {
    FlowBuilder flowBuilder =
        new FlowBuilder().setTableId(tableId).setFlowName("sourceMacMatchGoToTableFlow")
            .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie);
  ...
  public static FlowBuilder createDestMacMatchGoToTableFlow(MacAddress macAddress, Short tableId,
      Short targetTable, FlowId flowId, FlowCookie flowCookie) {
    FlowBuilder flowBuilder =
        new FlowBuilder().setTableId(tableId).setFlowName("sourceMacMatchGoToTableFlow")
            .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie);
   ...
   * @param address -- dns service address.
   * @param protocol -- protocol (UDP/TCP)
   * @param flowCookie -- flow cookie
  ...
  public static FlowBuilder createPermitPacketsToServerFlow(BigInteger metadata,
      BigInteger metadataMask, Ipv4Address dnsAddress, int port, short protocol, FlowId flowId,
      FlowCookie flowCookie) {
  ...
  public static FlowBuilder createPermitPacketsFromServerFlow(BigInteger metadata,
      BigInteger metadataMask, Ipv4Address dnsAddress, short protocol, FlowId flowId,
      FlowCookie flowCookie) {
   ...
   * @return
   */
  public static FlowBuilder createPermitPacketsToServerFlow(Ipv4Address dnsAddress, int port,
      short protocol, short tableId, short nextTable, FlowId flowId, FlowCookie flowCookie) {

    FlowBuilder flowBuilder =
        new FlowBuilder().setTableId(tableId).setFlowName("permitPacketsToServerFlow").setId(flowId)
            .setKey(new FlowKey(flowId)).setCookie(flowCookie);
    MatchBuilder matchBuilder = new MatchBuilder();
    FlowUtils.createEthernetTypeMatch(matchBuilder, 0x800);
   ...
   * @return
   */
  public static FlowBuilder createPermitPacketsFromServerFlow(Ipv4Address dnsAddress, int port,
      short protocol, short tableId, short nextTable, FlowId flowId, FlowCookie flowCookie) {

    FlowBuilder flowBuilder =
        new FlowBuilder().setTableId(tableId).setFlowName("permitPacketsFromServerFlow")
            .setId(flowId).setKey(new FlowKey(flowId)).setCookie(flowCookie);
    MatchBuilder matchBuilder = new MatchBuilder();
