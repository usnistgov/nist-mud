...
**/
/*
 * The following disclaimer applies to all modifications made by NIST 
 * 
 * 
 ...
 * @author mranga
 *
 * @see https://raw.githubusercontent.com/floodlight/floodlight/master/src/main/java/net/floodlightcontroller/packet/IPacket.java
 *
 */
public class LLDP {
	 protected LLDPTLV chassisId;
	    ...
	    public LLDP deserialize(byte[] data, int offset, int length) {
